    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
		  ...
		  <li class="nav-item">
            <a href="{{ route('admin.product') }}" class="nav-link @if(route('admin.product') == URL::current()) active @endif">
		  ...
		  <li class="nav-item">
            <a href="{{ route('admin.order') }}" class="nav-link @if(route('admin.order') == URL::current()) active @endif">
